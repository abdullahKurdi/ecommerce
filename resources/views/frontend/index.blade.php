      ...
      <div class="row">
        <div class="col-md-4">
            <a class="category-item" href="{{ route('frontend.product',$product_categories[0]->slug) }}">
                <img class="img-fluid" src="{{asset('assets/product_categories/cat-img-1.jpg')}}" alt="{{$product_categories[0]->name}}"/>
        ...
        <div class="col-md-4">
            <a class="category-item mb-4" href="{{ route('frontend.product',$product_categories[1]->slug) }}">
                <img class="img-fluid" src="{{asset('assets/product_categories/cat-img-2.jpg')}}" alt="{{$product_categories[1]->name}}"/>
                <strong class="category-item-title">Shoes</strong>
            </a>
            <a class="category-item" href="{{route('frontend.product',$product_categories[2]->slug)}}">
                <img class="img-fluid" src="{{asset('assets/product_categories/cat-img-3.jpg')}}" alt="{{$product_categories[2]->name}}"/>
                <strong class="category-item-title">Watches</strong>
            </a>
        </div>
        <div class="col-md-4">
            <a class="category-item" href="{{route('frontend.product',$product_categories[2]->slug)}}">
                <img class="img-fluid" src="{{asset('assets/product_categories/cat-img-4.jpg')}}" alt="{{$product_categories[2]->name}}"/>
