        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <h5 class="text-uppercase mt-4">Tags</h5>
                    <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                        ...
                        <div class="col-4" id="products-container-area">
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    <div class="badge text-white bg-"></div><a class="d-block" href="{{ route('frontend.product',$product->slug) }}">
                                        <img class="img-fluid w-100" src="{{asset('assets/products/'.$product->firstMedia->file_name)}}" alt="{{$product->name}}"></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            ...
                                            <li class="list-inline-item mr-0">
                                                <a  wire:click.prevent="$emit('showProductModalAction' ,'{{$product->slug}}')"  class="btn btn-sm btn-outline-dark" data-bs-target="#productView" data-bs-toggle="modal">
