...
class OmnipayService
{
    ...
    public function __construct($payment_method = 'PayPal_Express')
    {
        ...
        }elseif ($payment_method == 'Stripe\PaymentIntents'){
            $this->gateway = Omnipay::create('Stripe\PaymentIntents');
            $this->gateway->setApiKey(config('services.stripe.secret_key'));
...
//    {
//        return $this->createToken( $parameters);
//    }
//
//    public function authorize(array $parameter)
//    {
//
//        $response = $this->gateway->authorize($parameter)->send();
//        return $response;
//    }
